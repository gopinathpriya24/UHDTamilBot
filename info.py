...
PICS = (environ.get('PICS', 'https://telegra.ph/file/dbb3e968901b993132fe5.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/df85b2b9b5666d04d9b43.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/8d30d3bec2f809898f2a0.jpg")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001946084270')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gogreengopinath245:Tessa143@tessa.hh9gvbg.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://demon-mutf.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demon-mutf.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demon-mutf.onrender.com/".format(FQDN)
else:
    URL = "https://demon-mutf.onrender.com".format(FQDN)
